...
You are setting up VOCLI in **remote mode** — the STT and TTS servers run on the user's local machine (with mic/speakers), while Claude Code runs here on a remote VM.

## Step 1: Tell the user to start servers on their local machine
