---
name: install
description: Set up VOCLI — install all dependencies, models, and configure hooks
---
...
STT and TTS servers start automatically with `/vocli:talk`. After each step, report success or troubleshoot errors.
